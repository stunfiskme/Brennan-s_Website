...
namespace BrennansWebsite.Migrations
{
    ...
    [Migration("20250103193326_UpdateGardenerGardenRelationship")]
    partial class UpdateGardenerGardenRelationship
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BrennansWebsite.Models.Gardens", b =>
                {
                    b.HasOne("BrennansWebsite.Models.Gardener", "Gardener")
                        .WithOne("Garden")
                        .HasForeignKey("BrennansWebsite.Models.Gardens", "userId");
